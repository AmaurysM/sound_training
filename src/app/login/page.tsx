...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-linear-to-br from-blue-50 to-blue-100 p-4 sm:p-6 md:p-8 overflow-y-auto">
