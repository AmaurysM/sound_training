        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>You've been invited to join the NATA Training platform. To complete your registration and set up your account, please click the button below:</p>
              ...
              <div class="info-box">
                <strong>⏰ Important:</strong> This registration link will expire in 24 hours for security purposes. If it expires, you can request a new link on the registration page.
              </div>
              
              <p>When you click the link, you'll be able to:</p>
              <ul>
                <li>Create your secure password</li>
                <li>Access your training modules</li>
...
This link will expire in 24 hours. If it expires, you can request a new link on the registration page.
